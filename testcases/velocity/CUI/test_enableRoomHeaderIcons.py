...
class TestEnableRoomHeaderIcons:
    ...
    def test_enableRoomHeaderIcons(self):
        ...
        assert self.cui.visibilityOfHeaderIcons() is True
        # Uncheck the header icons
        self.headerProperties.clickHeaderIconsToggle()

        # check the room title is invisible
        try:
            self.cui.visibilityOfHeaderIcons()
