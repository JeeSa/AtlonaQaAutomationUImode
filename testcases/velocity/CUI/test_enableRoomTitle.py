...
class TestEnableRoomTitle:
    ...
    def test_enableRoomTitle(self):
        ...
        assert self.cui.visibilityOfRoomtitle() is True
        # Uncheck the room title
        self.headerProperties.clickRoomTitleToggle()

        # check the room title is invisible
        try:
            self.cui.visibilityOfRoomtitle()
