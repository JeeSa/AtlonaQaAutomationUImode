...
class TestEnableMacros:
    ...
    def test_enableMacros(self):
        ...
        assert self.cui.visibilityOfMacros() is True
        # Expand Room on section
        self.headerProperties.clickMacroDrawerExpand()
        # Uncheck the Room on
        self.headerProperties.clickMacroDrawerOtherToggle()

        # check the room title is invisible
        try:
            self.cui.visibilityOfMacros()
