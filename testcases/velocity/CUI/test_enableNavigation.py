...
class TestEnableNavigation:
    ...
    def test_enableNavigation(self):
        ...
        assert self.cui.visibilityOfNavigate() is True
        # Expand Room on section
        self.headerProperties.clickNavigationExpand()
        # Uncheck the Room on
        self.headerProperties.clickNavigationOtherToggle()

        # check the room title is invisible
        try:
            self.cui.visibilityOfNavigate()
