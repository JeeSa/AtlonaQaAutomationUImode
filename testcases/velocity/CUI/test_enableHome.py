...
class TestEnableHome:
    ...
    def test_enableHome(self):
        ...
        assert self.cui.visibilityOfHome() is True
        # Expand Room on section
        self.headerProperties.clickHomeExpand()
        # Uncheck the Room on
        self.headerProperties.clickHomeOtherToggle()

        # check the room title is invisible
        try:
            self.cui.visibilityOfHome()
