...
class TestStartInstantMeeting:
    ...
    def test_startInstantMeeting(self):
        ...
        for new_window in all_windows:
            if new_window != main_window:
                ...
                self.mRoomControl.clickStart()
                time.sleep(1)

                assert self.startMeetingPop.visibilityOfStartMeetingPopup() is True
                self.startMeetingPop.click_15mins()
                self.startMeetingPop.clickStart()
                time.sleep(1)
