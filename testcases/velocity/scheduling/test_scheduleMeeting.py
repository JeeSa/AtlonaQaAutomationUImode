    ...
    def test_scheduleMeeting(self):
        ...
        for new_window in all_windows:
            if new_window != main_window:
                ...
                self.mRoomControl.clickPlus()
                time.sleep(1)
                self.mRoomControl.clickBook3()

                assert self.schMeetingPop.visibilityOfSchMeetingPopup() is True
                self.schMeetingPop.enterSubject("Automation Meeting")
                self.schMeetingPop.clickSave()
