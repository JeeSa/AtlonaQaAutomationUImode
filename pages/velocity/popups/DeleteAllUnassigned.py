...
class DeleteAllUnassignedPopup:
    def __init__(self, driver, wait):
        self.driver = driver
        self.wait = wait

    # Locators
    CANCEL = "/html/body/div[6]/div/div[1]/div/div/div[2]/div[1]/button"
    DELETE = "/html/body/div[6]/div/div[1]/div/div/div[2]/div[2]/button"
    ...
    def visibilityOfDeleteAllUnassignedPop(self):
