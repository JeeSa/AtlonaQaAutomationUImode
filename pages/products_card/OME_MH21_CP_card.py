...
class OME_MH21_CP_card:
    def __init__(self, driver, wait):
        self.driver = driver
        self.wait = wait

    # Locators
    MH21_CP_DEVICE = "//h4[contains(text(),'AT-OME-MH21-CP')]"
    ...
    def getMH21CPDevice(self):
        self.driver.implicitly_wait(10)
        return self.driver.find_element(By.XPATH, self.MH21_CP_DEVICE)

    # Visibility of added technology
    def visibilityOfMH21CPDevice(self):
        # self.driver.implicitly_wait(10)
        time.sleep(3)
        if self.getMH21CPDevice().is_displayed():
            return True
        else:
            return False
