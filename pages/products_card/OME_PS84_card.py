...
class OME_PS84_card:
    ...
    # Locators
    PS84_DEVICE = "//h4[contains(text(),'AT-OME-PS84')]"
    ...
    def getPS84Device(self):
        self.driver.implicitly_wait(10)
        return self.driver.find_element(By.XPATH, self.PS84_DEVICE)

    # Visibility of added technology
    def visibilityOfPS84Device(self):
        # self.driver.implicitly_wait(10)
        time.sleep(3)
        if self.getPS84Device().is_displayed():
            return True
        else:
            return False
